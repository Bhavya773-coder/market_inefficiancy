...
from ai.commodity_replay_config import STEEL_HISTORICAL_REPLAY_CONFIG
...
def main():
    parser = argparse.ArgumentParser(description="Deterministic point-in-time Steel Historical Replay Runner CLI")
    ...
    episode_writer = SteelEpisodeDatasetWriter(args.episode_output)
    feature_writer = SteelEpisodeFeatureDatasetWriter(args.feature_output)
