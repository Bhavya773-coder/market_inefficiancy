...
async function tick(){
 ...
 document.getElementById('t').innerHTML =
  '<tr><th>Time</th><th>Symbol</th><th>Strategy</th><th>Direction</th><th>Net edge %</th><th>Net profit INR</th><th>Executable</th></tr>' +
  s.rows.map(r=>'<tr><td>'+r.timestamp.slice(11,19)+'</td><td>'+r.asset+'</td><td>'+r.strategy+
   '</td><td>'+r.direction+'</td><td>'+r.net_profit_pct.toFixed(4)+'</td><td>'+r.net_profit.toFixed(2)+
