...
class GoldEpisodeFeatureDatasetWriter:
    """
    Compatibility wrapper around CommodityEpisodeFeatureDatasetWriter for GOLD.
    """
    def __init__(self, dataset_path: str = "storage/gold_episode_features.jsonl"):
        self.writer = CommodityEpisodeFeatureDatasetWriter(dataset_path, GOLD_FEATURE_PROFILE)
