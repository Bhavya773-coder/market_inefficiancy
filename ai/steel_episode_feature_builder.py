...
class SteelEpisodeFeatureBuilder:
    """
    Compatibility wrapper around CommodityEpisodeFeatureBuilder for STEEL,
    preserving the original interface.
    """
    def __init__(self, feature_schema_version: str = "1.0"):
        self.builder = CommodityEpisodeFeatureBuilder(STEEL_FEATURE_PROFILE)
