...
class SteelLiveQuoteAdapter:
    """
    Live quote adapter for Steel. Wraps SteelHistoricalReplayAdapter
    ...
    def __init__(self, config: CommodityReplayConfig, detector: Optional[SteelInefficiencyDetector] = None):
        ...
        self.underlying_adapter = SteelHistoricalReplayAdapter(config, detector)
